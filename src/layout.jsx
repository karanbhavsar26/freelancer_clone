            ...
            <div className="flex md:gap-12 gap=2 md:justify-around cursor-pointer font-semibold ">
                <div className="hover:text-blue-300 hidden md:block">How It Works </div>
                    ...
                    <div
                        ...
                        className={`hover:text-blue-300 hidden md:block`}
                        >Browse Jobs </div>
                </div>
                </div>
               
                <div className="flex gap-8">
                        <div className="hover:text-blue-300 hover:cursor-pointer" onClick={()=>navigate("/login")}>Log In </div>
                        <div className="hover:text-blue-300 hover:cursor-pointer" >Sign Up </div>
                    </div>
            </div>
